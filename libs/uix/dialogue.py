...
def input_dialog(title='Title', hint_text='Write something',
    ...
    input_dialog = Builder.template('InputText', title=title, hint_text=hint_text, text_button_ok=text_button_ok, text_button_cancel=text_button_cancel, events_callback=events_callback)
    input_dialog.open()
