...
class MobileApp(MDApp):
    ...
    def load_contacts(self, interval):
        ...
        while default_timer() < (Clock.get_time() + MAX_TIME):
    ...
    def load_all_kv_files(self):
        directory_kv_files = '{}/Libs/ux/kv'.format(self.directory)
        ...
        class Error(MobileApp):
            ...
            def build(self):
                self.win_report = BugReporter(
                    ...
                    icon_background='Data/Img/logo.png'
                )
